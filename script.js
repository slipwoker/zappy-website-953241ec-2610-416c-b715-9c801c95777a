document.addEventListener('DOMContentLoaded', function () {
  ...
  if (animatableElements.length > 0) {
    ...
    if (!document.getElementById(styleId)) {
      ...
      style.id = styleId;
      style.textContent = [
        '.' + animatedClass + '{opacity:0;transform:translateY(24px);transition:opacity 0.6s ease,transform 0.6s ease;}',
        '.' + animatedClass + '.' + visibleClass + '{opacity:1;transform:translateY(0);}',
      ].join('');
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Nails by PATIT משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '953241ec-2610-416c-b715-9c801c95777a',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '953241ec-2610-416c-b715-9c801c95777a';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '953241ec-2610-416c-b715-9c801c95777a';
